...
class Game {
    ...
    constructor () {
        ...
        this.score = 0; // Para reflejar la puntuación del juego
    }
    ...
    removeOpponent () {
        ...
        /* Al acabar con el oponente inicial debe aparer el Jefe 
        this.opponent = new Opponent(this);*/
        if (this.opponent instanceof Boss === false)  {
     ...
     */
    endGame () {
        let imageEnd = GAME_OVER_PICTURE;
        if (this.score > 1 && this.player.lives > 0) {
            imageEnd = YOU_WIN_PICTURE;
        }
        this.ended = true;
        let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, imageEnd)
        gameOver.render();
    }
