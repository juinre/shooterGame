...
class Opponent extends Character {
     ...
     */
    /* Cambiamos el constructor para que admita más parámetros y sólo los inicialice
    cuando no se pasen como argumento en el constructor*/
    constructor (game, width, height, speed, myImage, myImageDead) {
        ...
        let x = getRandomNumber(game.width - width / 2);
        let y = 0;
